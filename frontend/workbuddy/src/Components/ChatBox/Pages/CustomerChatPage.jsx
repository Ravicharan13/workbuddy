...
export default function CustomerChatPage() {
  ...
  // Handle window resize to detect layout type
  useEffect(() => {
  ...
  // Fetch chat based on URL chatRoomId
  useEffect(() => {
  ...
  return (
    ...
    <div className="h-[91vh] md:h-[95vh] lg:h-[92vh] bg-gray-100 dark:bg-gray-900">
      <div className="flex h-full">
        {/* Sidebar - only show on desktop or when chat is not active on mobile */}
        {(!isMobile || !activeChat) && (
          <div className="w-full md:w-[300px] lg:w-[350px]">
            <ChatSidebar onSelectChat={setActiveChat} userRole="customer" />
          </div>
        )}
